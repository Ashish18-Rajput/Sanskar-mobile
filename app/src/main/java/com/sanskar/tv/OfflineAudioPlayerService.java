...
public class OfflineAudioPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private ArrayList<OfflineData> audioList;
    private OfflineData activeAudio;
    ...
    private void register_playNewAudio() {
        ...
        IntentFilter filter = new IntentFilter(DownloadsFragment.Broadcast_PLAY_NEW_AUDIO);
    ...
    private BroadcastReceiver playNewAudio = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            audioList = (ArrayList<OfflineData>) intent.getSerializableExtra("offlinebhajanarray");
    ...
    private void updateMetaData() {
        Bitmap albumArt = BitmapFactory.decodeResource(getResources(),
                R.mipmap.thumbnail_placeholder); //replace with medias albumArt
        // Update the current metadata
        mediaSession.setMetadata(new MediaMetadata.Builder()
                .putBitmap(MediaMetadata.METADATA_KEY_ALBUM_ART, albumArt)
                .putString(MediaMetadata.METADATA_KEY_ARTIST, activeAudio.getName())
                .putString(MediaMetadata.METADATA_KEY_ALBUM, activeAudio.getName())
    ...
    private void initMediaPlayer() {
        ...
        try {
            ...
            try {
                ...
                offlinemediaPlayer.setDataSource(activeAudio.getPath());
            } catch (IOException e) {
                e.printStackTrace();
                stopSelf();
            }
    ...
    public class LocalBinder extends Binder {
        public OfflineAudioPlayerService getService(){
            return OfflineAudioPlayerService.this;
        }
