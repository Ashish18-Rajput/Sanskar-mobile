...
/*    public static PlaybackManager getInstance(Context mContext) {
    ...
    private Listeners.LoadSongListener loadSongListener = new Listeners.LoadSongListener() {
        ...
        public void onSongLoaded() {
            //((HomeActivityy) mContext).setAllSongs();
        }
    };
            ...
            if (cursor != null) {
                if (cursor.moveToFirst()) {
                    ...
                    do {
                        ...
                        song.put(BhajansCategoryFragment.SONG_TITLE, song_title);
                        song.put(BhajansCategoryFragment.DISPLAY_NAME, display_name);
                        song.put(BhajansCategoryFragment.SONG_ID, "" + song_id);
                        song.put(BhajansCategoryFragment.SONG_PATH, song_path);
                        song.put(BhajansCategoryFragment.ALBUM_NAME, album_name);
                        song.put(BhajansCategoryFragment.ARTIST_NAME, artist_name);
                        song.put(BhajansCategoryFragment.SONG_DURATION, "" + song_duration);
                        song.put(BhajansCategoryFragment.SONG_POS, "" + i);
                        songsList.add(song);
                        ++i;
    ...
    public static void onStopService() {
        //((HomeActivityy) mContext).setPlayPauseView(false);
  ...
  /* public static void playSong(final HashMap<String, String> hashMap) {
       ...
       new Thread(new Runnable() {
           ...
           public void run() {
               ...
               i.putExtra(BhajansCategoryFragment.SONG_PATH, hashMap.get(BhajansCategoryFragment.SONG_PATH));
               i.putExtra(BhajansCategoryFragment.SONG_TITLE, hashMap.get(BhajansCategoryFragment.SONG_TITLE));
               i.putExtra(BhajansCategoryFragment.ARTIST_NAME, hashMap.get(BhajansCategoryFragment.ARTIST_NAME));
               i.putExtra(BhajansCategoryFragment.ALBUM_NAME, hashMap.get(BhajansCategoryFragment.ALBUM_NAME));
               mContext.startService(i);
               int pos = Integer.parseInt(hashMap.get(BhajansCategoryFragment.SONG_POS));
