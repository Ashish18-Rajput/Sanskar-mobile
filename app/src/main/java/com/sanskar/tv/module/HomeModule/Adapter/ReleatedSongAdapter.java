...
public class ReleatedSongAdapter extends RecyclerView.Adapter<ReleatedSongAdapter.ReleatedViewHolder> {
    List<Bhajan> bhajanList;
    Context context;
    private boolean isArtistBhajan;
    int Type;
    public static  Bhajan[] relatedbhajan;
   // Bhajan[] bhajans;
    public ReleatedSongAdapter(List<Bhajan> bhajanList, Context context) {
    ...
    public ReleatedViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ReleatedSongAdapter.ReleatedViewHolder(LayoutInflater.from(context).inflate(R.layout.single_item_related_song,null));
    }
                                ...
                                if (!HomeFragment.serviceBound) {
                                    if (!BhajansCategoryFragment.serviceBound) {
                                     //   Constants.AUDIO_ACTIVE_LIST = "bhajan";
                                        ...
                                        Constants.AUDIO_ACTIVE_LIST = "relatedbhajan";
