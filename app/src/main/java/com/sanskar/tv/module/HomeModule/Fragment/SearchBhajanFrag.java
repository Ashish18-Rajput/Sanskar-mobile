...
public class SearchBhajanFrag extends Fragment {

    RecyclerView recyclerView;
    Context context;
    BhajanViewAllAdapter adapter;
    Bhajan[] bhajanList;
    RecyclerView.LayoutManager layoutManager;


    public SearchBhajanFrag() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.bhajan_search_fagment, container, false);
    }
    ...
    private void getBundleData() {
        if (getArguments() != null) {
            ...
            if (bundle.containsKey("bhajanList")) {
                bhajanList = (Bhajan[]) bundle.getSerializable("bhajanList");
            }
        }
    }
    ...
    private void initView(View view) {
        ...
        adapter = new BhajanViewAllAdapter(bhajanList, context, false);
