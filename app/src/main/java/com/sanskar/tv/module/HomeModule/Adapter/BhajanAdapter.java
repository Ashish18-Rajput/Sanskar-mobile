...
public class BhajanAdapter extends RecyclerView.Adapter<BhajanAdapter.ViewHolder> {
    ...
    public BhajanAdapter(Context context,Bhajan[] bhajans, String[] imgs, BhajanInterface bhajanInterface,Fragment fragment) {
